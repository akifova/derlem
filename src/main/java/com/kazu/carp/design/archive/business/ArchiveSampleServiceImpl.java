...
public class ArchiveSampleServiceImpl extends BaseArchiveService implements IArchiveSampleService {
    ...
    @Override
    public void convertToSample(ArchiveDto archiveDto) throws FieldsCanNotBeNullException {

        Archive archive = dao.getById(archiveDto.getId());
        prepareBaseDataAndReturn(archiveDto, archive, ArchiveStatus.RD, false);
        ...
        archive.setArchiveStatus(ArchiveStatus.SAMPLE);
        dao.save(archive);
